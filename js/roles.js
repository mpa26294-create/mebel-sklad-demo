...
const ROLE_GUARDS={
  ...
  confirmTechnologySave:'tech.edit',toggleTechStageOpForm:'tech.edit',addTechStageOp:'tech.edit',updateTechStageOp:'tech.edit',removeTechStageOp:'tech.edit',deleteSavedTechOp:'tech.edit',toggleOrderStageOpForm:'orders.technology',addOrderStageOp:'orders.technology',updateOrderStageOp:'orders.technology',removeOrderStageOp:'orders.technology',deleteSavedOrderOp:'orders.technology',deleteTechnology:'tech.edit',duplicateTechnology:'tech.edit',openCreateTechnologyModal:'tech.edit',openTechnologySaveDialog:'tech.edit',saveNewTechnology:'tech.edit',saveTechnologyAndReturn:'tech.edit',
...
function userCanSection(sectionId){
  if(sectionId==='users')return isOwnerUser(); // v8.36: «Пользователи» — отдельно от общей системы ролей, только владельцу
