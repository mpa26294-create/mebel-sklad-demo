...
function renderTopbarProfile(){
  ...
  const roleEl=document.getElementById('tpUserRole');if(roleEl)roleEl.textContent=profileDisplayRole()||(currentUser&&typeof rolesLabel==='function'?rolesLabel():t('roleNotSet'));
